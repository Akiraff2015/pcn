...
router.get('/api/member', (req, res) => {
  res.json({
    ...
    "strength": [{90, exp: 5691983}],
    "constitution": [{99, exp: 14988361}],
    "ranged": [{id: 99, exp: 13568494}],
    "prayer": [{95, exp: 9156284}],
